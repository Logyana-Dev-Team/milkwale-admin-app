...
// fetch product list by category
  ...
  return (
    <Fragment>
      {/* Black Overlay */}
      <div
        onClick={(e) => dispatch({ type: "addSubpackModal", payload: false })}
        className={`${
          data.addSubpackModal ? "" : "hidden"
        ...
        <div className="mt-32 md:mt-0 relative bg-white w-11/12 md:w-3/6 shadow-lg flex flex-col items-center space-y-4 px-4 py-4 md:px-8">
          <div className="flex items-center justify-between w-full pt-4">
            ...
            <span
              ...
              onClick={(e) =>
                dispatch({ type: "addSubpackModal", payload: false })
              }
          ...
          <form className="w-full" onSubmit={(e) => submitForm(e)}>
            <div className="flex space-x-1 py-4">
              <div className="w-1/2 flex flex-col space-y-1 space-x-1">
                <label htmlFor="name">Subpack Name *</label>
                <input
                  value={fData.pName}
                  onChange={(e) =>
                    setFdata({
            ...
            <div className="flex space-x-1 py-4">
              ...
              <div className="w-1/2 flex flex-col space-y-1">
                <label htmlFor="product">Subpack Product *</label>
                <select
                  value={fData.pProduct}
                  onChange={(e) =>
                    setFdata({
                      ...fData,
                      error: false,
            ...
            <div className="flex space-x-1 py-4">
              <div className="w-1/2 flex flex-col space-y-1">
                <label htmlFor="credits">Subpack Credits*</label>
                <input
                  value={fData.pCredits}
                  onChange={(e) =>
                    setFdata({
                      ...fData,
                      error: false,
...
export default AddSubpackModal;
