...
const EditSubpackModal = (props) => {
  ...
  return (
    <Fragment>
      ...
      <div
        onClick={(e) =>
          dispatch({ type: "editSubpackModalClose", payload: false })
        }
        className={`${
          data.editSubpackModal.modal ? "" : "hidden"
              ...
              {editformData.pImages ? (
                <div className="flex space-x-1">
                  <img
                    ...
                    src={`${apiURL}/uploads/subpacks/${editformData.pImages[0]}`}
                    alt="subpackImage"
                  />
                  <img
                    className="h-16 w-16 object-cover"
                    src={`${apiURL}/uploads/subpacks/${editformData.pImages[1]}`}
                    alt="subpackImage"
                  />
                </div>
              ) : (
...
export default EditSubpackModal;
